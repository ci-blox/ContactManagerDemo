    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="form-group<?php echo form_error('photo') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='photoimg' type='text' name='photoimg' value="<?php echo set_value('photoimg', isset($contacts->photoimg) ? $contacts->photoimg : ''); ?>" />
                    <input id='photo' type='hidden' name='photo' maxlength='255' value="<?php echo set_value('photo', isset($contacts->photo) ? $contacts->photo : ''); ?>" />
        ...
        <fieldset class='form-actions'>
            ...
            <?php echo anchor('/authenticated/contacts', lang('contacts_cancel'), 'class="btn btn-warning"'); ?>
