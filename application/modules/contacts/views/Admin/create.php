<?php
$page_title = lang('contacts_action_create');
...
<div class='admin-box container'>
    ...
    <?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="hide form-group<?php echo form_error('created_on') ? ' error' : ''; ?>">
            ...
            <div class="hide form-group<?php echo form_error('created_by') ? ' error' : ''; ?>">
            ...
            <div class="hide form-group<?php echo form_error('modified_on') ? ' error' : ''; ?>">
            ...
            <div class="hide form-group<?php echo form_error('modified_by') ? ' error' : ''; ?>">
            ...
            <div class="hide form-group<?php echo form_error('deleted') ? ' error' : ''; ?>">
                <div class='checkbox'>
                    <label for='deleted'>
            ...
            <div class="form-group<?php echo form_error('photo') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='photoimg' type='file' name='photoimg' value="<?php echo set_value('photoimg', isset($contacts->photoimg) ? $contacts->photoimg : ''); ?>" />
                    <input id='photo' type='hidden' name='photo' value="<?php echo set_value('photo', isset($contacts->photo) ? $contacts->photo : ''); ?>" />
